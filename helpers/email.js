...
export const sendEmailWhenExpirationItems = async (email, items) => {
  ...
  const mailOptions = {
    ...
    text: `
      Recuerda que la fecha de vencimiento de los siguientes productos en tu inventario está proxima a cumplirse.
...
export const sendEmailItemsWithoutExpirationDateItems = async (email, items) => {
  ...
  const mailOptions = {
    ...
    text: `
      Recuerda agregarle fecha de vencimiento a los siguientes productos.
